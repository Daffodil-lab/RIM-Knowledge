...
- 同じ出典の前項: [確定#305：分身固有の工業メカニクス（Tower Ledger等）をShion Race: 無零花の単一工業システムへ統合——Shion Race: 無零花は大幅な改変を予定](/decisions/decision-0305-確定-分身固有の工業メカニクス-等-を-無零花の単一工業システム.md)
- 同じ出典の次項: [確定#307：シオン/Shion_地場_仕様書_v1.md§12（旧12.1〜12.13：地場濃度ゲージ・無零花・発電機・濃縮真空エネルギー・cell・パイプライン設備・3Dプリンター・液体装薬注入機、全て）を原則放棄し、Tower Ledger統合工業システム（§13）へ全面統合](/decisions/decision-0307-確定-シオン-地場-仕様書-旧-地場濃度ゲージ-無零花-発電機.md)
