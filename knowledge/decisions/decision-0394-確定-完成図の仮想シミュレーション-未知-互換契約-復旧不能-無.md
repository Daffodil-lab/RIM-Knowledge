...
- 同じ出典の前項: [確定#393：β版Pawn Foundry、補充可能個体、登録再実体化、Clone Colony](/decisions/decision-0393-確定-版-補充可能個体-登録再実体化.md)
- 同じ出典の次項: [確定#395：Matter NetworkをKombinat倉庫基盤として採用し、物理資源を実Thingへ統一](/decisions/decision-0395-確定-を-倉庫基盤として採用し-物理資源を実-へ統一.md)
