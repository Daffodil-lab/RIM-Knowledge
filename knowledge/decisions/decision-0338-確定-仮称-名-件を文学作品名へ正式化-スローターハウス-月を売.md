...
- 同じ出典の前項: [確定#337：今回の開発目的をMVP（最小実行可能製品）までと明記（対象：Tower Ledger統合工業システム§13）](/decisions/decision-0337-確定-今回の開発目的を-最小実行可能製品-までと明記-対象-統合.md)
- 同じ出典の次項: [確定#339：仮称2件を最終確定——「Shion Race: 地場」→「Shion Race: Kombinat」、「分身」→「Shion Race: The Hive」](/decisions/decision-0339-確定-仮称-件を最終確定-地場-分身.md)
