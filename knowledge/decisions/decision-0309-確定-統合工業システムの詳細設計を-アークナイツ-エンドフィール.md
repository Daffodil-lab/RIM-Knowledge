...
- 同じ出典の前項: [確定#308：確定#307の放棄範囲を修正——3Dプリンター・液体装薬注入機はTower Ledger統合工業の設備として存続、cell/CVEは台帳スカラー方式に統一、PAC/パイプライン系は独立システムとして廃止](/decisions/decision-0308-確定-確定-の放棄範囲を修正-プリンター-液体装薬注入機は-統合.md)
- 同じ出典の次項: [確定#310：Tower Ledger統合工業システムの基礎資源をCVE・デジタル資材・労務資本・Cellの4種へ絞り込み（ステラリスの資源体系を参考）——戦略資源・特殊素材は後回し](/decisions/decision-0310-確定-統合工業システムの基礎資源を-デジタル資材-労務資本-の.md)
