...
- 同じ出典の前項: [確定#254：研究「コア精錬」「弱点対抗ツリー」「熱エンジン制御」の3研究を「統合されたシステム」1研究へ完全統合、関連する§13番号を全面的に連番化](/decisions/decision-0254-確定-研究-コア精錬-弱点対抗ツリー-熱エンジン制御-の-研究を.md)
- 同じ出典の次項: [確定#256：装備段1・段2の解禁研究をそれぞれ「Diaspora Tech company」「旧式装備」として新設・分離](/decisions/decision-0256-確定-装備段-段-の解禁研究をそれぞれ-旧式装備-として新設-分.md)
