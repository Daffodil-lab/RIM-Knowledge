...
- 同じ出典の前項: [確定#260：バランス基準書v1の既存懸念5件は設計意図と確認、CoreMOD資料v1§4の任意pt記述を訂正](/decisions/decision-0260-確定-バランス基準書-の既存懸念-件は設計意図と確認-資料-の任.md)
- 同じ出典の次項: [確定#262：装備数値表v1・迫撃砲の梱包/展開運用をFFF Deployable Itemで確定、「野戦簡易型」新設は撤回](/decisions/decision-0262-確定-装備数値表-迫撃砲の梱包-展開運用を-で確定-野戦簡易型.md)
