...
- 同じ出典の前項: [確定#271：3Dプリンター・液体装薬注入機は有人稼働／無人稼働の二種類を持つと確定](/decisions/decision-0271-確定-プリンター-液体装薬注入機は有人稼働-無人稼働の二種類を持.md)
- 同じ出典の次項: [確定#273：ステルス性は数値が低いほど良いと訂正、既存の×0.9/×0.8/−1補正はすべて有利なボーナスと確定](/decisions/decision-0273-確定-ステルス性は数値が低いほど良いと訂正-既存の-補正はすべて.md)
