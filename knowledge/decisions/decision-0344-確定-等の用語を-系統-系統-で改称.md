...
- 同じ出典の前項: [確定#343：同盟のサイキック技術は精神への直接干渉より物理的な力への変換を得意とする（秘文字含む）](/decisions/decision-0343-確定-同盟のサイキック技術は精神への直接干渉より物理的な力への変.md)
- 同じ出典の次項: [確定#345：同盟の正式条約名＝クピナー条約機構](/decisions/decision-0345-確定-同盟の正式条約名-クピナー条約機構.md)
