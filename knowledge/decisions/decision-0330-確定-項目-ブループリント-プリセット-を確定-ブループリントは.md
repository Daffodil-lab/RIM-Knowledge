...
- 同じ出典の前項: [確定#329：第二コアの機能として「本拠点消滅時の再出発拠点」を確定](/decisions/decision-0329-確定-第二コアの機能として-本拠点消滅時の再出発拠点-を確定.md)
- 同じ出典の次項: [確定#331：Recommendations項目5「必須だが調整可能」の二段構えを確定——遠隔拠点＋休眠遺構の再起動だけで簡易ルートとして成立させる](/decisions/decision-0331-確定-項目-必須だが調整可能-の二段構えを確定-遠隔拠点-休眠遺.md)
