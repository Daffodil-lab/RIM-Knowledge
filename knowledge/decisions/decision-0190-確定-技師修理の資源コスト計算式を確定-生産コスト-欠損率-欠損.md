...
- 同じ出典の前項: [確定#189：有機機械限定特性リストは現状で十分と確定（「非機械であること」で足りる）](/decisions/decision-0189-確定-有機機械限定特性リストは現状で十分と確定-非機械であること.md)
- 同じ出典の次項: [確定#191：有機機械側のスタッカブル重ね掛け上限は基本的に10〜50の範囲と確定](/decisions/decision-0191-確定-有機機械側のスタッカブル重ね掛け上限は基本的に-の範囲と確.md)
