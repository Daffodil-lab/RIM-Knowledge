...
- 同じ出典の前項: [確定#390：Kombinat停止保存、資産価値、破壊時保全、性能優先方式](/decisions/decision-0390-確定-停止保存-資産価値-破壊時保全-性能優先方式.md)
- 同じ出典の次項: [確定#392：Kombinatを生産・消費・流通へ集約した汎用工業とする](/decisions/decision-0392-確定-を生産-消費-流通へ集約した汎用工業とする.md)
