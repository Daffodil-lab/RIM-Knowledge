...
- 同じ出典の前項: [確定#368：帝国の降伏、吸収、ソフェル継承、帝国式建築](/decisions/decision-0368-確定-帝国の降伏-吸収-ソフェル継承-帝国式建築.md)
- 同じ出典の次項: [確定#370：配置先に迷う場合のバックストーリー／研究フォールバック](/decisions/decision-0370-確定-配置先に迷う場合のバックストーリー-研究フォールバック.md)
