...
- 同じ出典の前項: [確定#395：Matter NetworkをKombinat倉庫基盤として採用し、物理資源を実Thingへ統一](/decisions/decision-0395-確定-を-倉庫基盤として採用し-物理資源を実-へ統一.md)
- 同じ出典の次項: [確定#397：Matter Networkを無改造の必須依存へ固定し、上流欠陥とStasisをKombinat監査から除外](/decisions/decision-0397-確定-を無改造の必須依存へ固定し-上流欠陥と-を-監査から除外.md)
