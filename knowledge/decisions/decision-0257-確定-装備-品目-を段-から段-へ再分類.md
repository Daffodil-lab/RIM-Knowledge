...
- 同じ出典の前項: [確定#256：装備段1・段2の解禁研究をそれぞれ「Diaspora Tech company」「旧式装備」として新設・分離](/decisions/decision-0256-確定-装備段-段-の解禁研究をそれぞれ-旧式装備-として新設-分.md)
- 同じ出典の次項: [確定#258：CoreMOD資料v1§4.3・無制限スタック特性に整数上限式を新設](/decisions/decision-0258-確定-資料-無制限スタック特性に整数上限式を新設.md)
