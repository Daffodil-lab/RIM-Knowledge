...
- 同じ出典の前項: [確定#326：探索⇄工業の循環（資源ノード発見）を確定——バニラ非製造資源・対応MOD資源の効率的な入手経路として位置づけ](/decisions/decision-0326-確定-探索-工業の循環-資源ノード発見-を確定-バニラ非製造資源.md)
- 同じ出典の次項: [確定#328：遠隔拠点（第二マップを生成しない工場/設備展開）を追加——資源ノード対応生産・非対応時の扱い・砲兵陣地/航空基地/軌道エレベーター等の設備群](/decisions/decision-0328-確定-遠隔拠点-第二マップを生成しない工場-設備展開-を追加-資.md)
