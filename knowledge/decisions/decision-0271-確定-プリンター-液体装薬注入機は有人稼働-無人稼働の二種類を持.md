...
- 同じ出典の前項: [確定#270：3Dプリンターの無人稼働仕様を確定、新設・液体装薬注入機を追加](/decisions/decision-0270-確定-プリンターの無人稼働仕様を確定-新設-液体装薬注入機を追加.md)
- 同じ出典の次項: [確定#272：観測・通信装備（TZOFEH/KESHER）とステルス装備（NISTAR/MISTOR/MAGENシリーズ）を新設、既存装備にステルス性補正を追加](/decisions/decision-0272-確定-観測-通信装備-とステルス装備-シリーズ-を新設-既存装備.md)
