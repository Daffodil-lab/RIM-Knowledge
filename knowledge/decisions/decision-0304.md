...
- 同じ出典の前項: [確定#303：外部リファレンス「アークナイツ:エンドフィールド AICシステム設計分析レポート」を新規資料として追加](/decisions/decision-0303.md)
- 同じ出典の次項: [確定#305：分身固有の工業メカニクス（Tower Ledger等）をShion Race: 無零花の単一工業システムへ統合——Shion Race: 無零花は大幅な改変を予定](/decisions/decision-0305.md)
