...
- 同じ出典の前項: [確定#392：Kombinatを生産・消費・流通へ集約した汎用工業とする](/decisions/decision-0392-確定-を生産-消費-流通へ集約した汎用工業とする.md)
- 同じ出典の次項: [確定#394：Kombinat完成図の仮想シミュレーション、未知MOD互換契約、復旧不能・無限容量の封鎖](/decisions/decision-0394-確定-完成図の仮想シミュレーション-未知-互換契約-復旧不能-無.md)
