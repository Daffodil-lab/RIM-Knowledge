...
- 同じ出典の前項: [確定#239：確定#237「設計ドクトリン」（個体単位・非拘束）とは別に、コロニー全体で一度だけ選ぶHoi4式排他選択「コロニードクトリン」（物量/機動戦/火力偏重/堅陣防御の4択）を新設](/decisions/decision-0239-確定-確定-設計ドクトリン-個体単位-非拘束-とは別に-コロニー.md)
- 同じ出典の次項: [確定#241：ドクトリン軌道「機甲」のCoreMOD対応効果を具体化——個人重装甲の装甲値強化＋重装甲特有の移動デバフ軽減（移動バフ）](/decisions/decision-0241-確定-ドクトリン軌道-機甲-の-対応効果を具体化-個人重装甲の装.md)
