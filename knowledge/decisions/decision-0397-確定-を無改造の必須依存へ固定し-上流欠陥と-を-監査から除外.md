...
- 同じ出典の前項: [確定#396：装備の抽象指定を装備ファミリー＋非物理ポイントへ簡略化](/decisions/decision-0396-確定-装備の抽象指定を装備ファミリー-非物理ポイントへ簡略化.md)
- 後続決定: [確定#398：α版からCore独自保管・接続基盤を採用する](/decisions/decision-0398-確定-版から-独自保管-接続基盤を採用する.md)
