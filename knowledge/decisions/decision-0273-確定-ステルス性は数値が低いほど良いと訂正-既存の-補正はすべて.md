...
- 同じ出典の前項: [確定#272：観測・通信装備（TZOFEH/KESHER）とステルス装備（NISTAR/MISTOR/MAGENシリーズ）を新設、既存装備にステルス性補正を追加](/decisions/decision-0272-確定-観測-通信装備-とステルス装備-シリーズ-を新設-既存装備.md)
- 同じ出典の次項: [確定#274：TZOFEH/KESHERによる観測行為はステルス性の露見条件から除外すると確定](/decisions/decision-0274-確定-による観測行為はステルス性の露見条件から除外すると確定.md)
