...
- 同じ出典の前項: [確定#278：クラスター弾をジャミング弾へ統合し、独立弾種としては廃止](/decisions/decision-0278.md)
- 同じ出典の次項: [確定#280：NISTAR/MISTOR/MAGENシリーズ（§2.19）のSharp/Blunt/Heat/Mass/costList・シールド値・ステルス性演算順序を確定](/decisions/decision-0280.md)
