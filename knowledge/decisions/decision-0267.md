...
- 同じ出典の前項: [確定#266：CoreMOD資料v1§7.3・コロニードクトリンをCoreMODスコープから除外し、拡張MOD「エンダーのゲーム」へ移管](/decisions/decision-0266.md)
- 同じ出典の次項: [確定#268：ステルス性メカニクスの夜間補正を確定——安全接近距離を煙幕と同じ×0.5に](/decisions/decision-0268.md)
