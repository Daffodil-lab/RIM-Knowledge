...
- 同じ出典の前項: [確定#115：ドクトル・ジバゴの史実の結末（皇族の死に絶え）訂正](/decisions/decision-0115-確定-ドクトル-ジバゴの史実の結末-皇族の死に絶え-訂正.md)
- 同じ出典の次項: [確定#117：FTL時間旅行・亜光速航行は純粋なlore/設定であり実装不要](/decisions/decision-0117-確定-時間旅行-亜光速航行は純粋な-設定であり実装不要.md)
