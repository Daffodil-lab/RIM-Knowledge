...
- 同じ出典の前項: [確定#262：装備数値表v1・迫撃砲の梱包/展開運用をFFF Deployable Itemで確定、「野戦簡易型」新設は撤回](/decisions/decision-0262-確定-装備数値表-迫撃砲の梱包-展開運用を-で確定-野戦簡易型.md)
- 同じ出典の次項: [確定#264：将来構想・独自開拓団の「開拓戦争」（毒ガス＋ステルスクローク突撃部隊、未着手）](/decisions/decision-0264-確定-将来構想-独自開拓団の-開拓戦争-毒ガス-ステルスクローク.md)
