...
- 同じ出典の前項: [確定#165：Tier別pt予算（Tier0=任意pt3〜Tier+20=任意pt60）](/decisions/decision-0165-確定-別-予算-任意-任意.md)
- 同じ出典の次項: [確定#167：任意付与特性プールの拡張](/decisions/decision-0167-確定-任意付与特性プールの拡張.md)
