...
- 同じ出典の前項: [確定#259：CoreMOD資料v1§6・Tier強化（後天的なTier昇格）を新設](/decisions/decision-0259-確定-資料-強化-後天的な-昇格-を新設.md)
- 同じ出典の次項: [確定#261：装備数値表v1・銃搭載バイポットによる展開システムを検討開始（未実装）](/decisions/decision-0261-確定-装備数値表-銃搭載バイポットによる展開システムを検討開始.md)
