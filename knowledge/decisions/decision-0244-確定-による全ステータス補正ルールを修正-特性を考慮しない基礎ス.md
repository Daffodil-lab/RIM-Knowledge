...
- 同じ出典の前項: [確定#243：「必要素材種類数」仕様をプロジェクト全体から廃棄——確定#169由来のTier別必要素材種類数表・関連文言をCoreMOD資料/バランス基準書/資源植物資料/コンセプト設計書の4資料から削除](/decisions/decision-0243-確定-必要素材種類数-仕様をプロジェクト全体から廃棄-確定-由来.md)
- 同じ出典の次項: [確定#245：身体ロードアウトのインプラント（標準を除く）は必ず濃縮真空エネルギー＋液化メカナイトを消費すると確定](/decisions/decision-0245-確定-身体ロードアウトのインプラント-標準を除く-は必ず濃縮真空.md)
