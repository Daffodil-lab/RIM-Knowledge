...
- 同じ出典の前項: [確定#166：体力システムの機械化（冷媒漏出・技師修理）](/decisions/decision-0166-確定-体力システムの機械化-冷媒漏出-技師修理.md)
- 同じ出典の次項: [確定#168：任意付与特性プールに正13種・負14種を追加（正35：負26の構成に調整）](/decisions/decision-0168-確定-任意付与特性プールに正-種-負-種を追加-正-負-の構成に.md)
