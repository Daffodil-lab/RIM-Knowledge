...
- 同じ出典の前項: [確定#6：変換＝殲滅／同化は同一行為。捕虜→完全シオン/Shion化（均質な軍団）。自発的改宗者・構成諸民族は肉体保持可。](/decisions/decision-0006.md)
- 同じ出典の次項: [確定#8：過熱深刻度＝火傷×日数、未整備と累積。](/decisions/decision-0008.md)
