...
- 同じ出典の前項: [確定#261：装備数値表v1・銃搭載バイポットによる展開システムを検討開始（未実装）](/decisions/decision-0261.md)
- 同じ出典の次項: [確定#263：装備数値表v1・スポッター連動の狙撃システム＋最優先目標指定コマンドを検討開始（未実装）](/decisions/decision-0263.md)
