...
- 同じ出典の前項: [確定#258：CoreMOD資料v1§4.3・無制限スタック特性に整数上限式を新設](/decisions/decision-0258-確定-資料-無制限スタック特性に整数上限式を新設.md)
- 同じ出典の次項: [確定#260：バランス基準書v1の既存懸念5件は設計意図と確認、CoreMOD資料v1§4の任意pt記述を訂正](/decisions/decision-0260-確定-バランス基準書-の既存懸念-件は設計意図と確認-資料-の任.md)
