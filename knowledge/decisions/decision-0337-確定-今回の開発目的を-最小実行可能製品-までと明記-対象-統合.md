...
- 同じ出典の前項: [確定#336：新規コア（Nexus Core／Nexusサブコア）はプレイヤーが直接製造できず、回収または名声購入で入手する](/decisions/decision-0336-確定-新規コア-サブコア-はプレイヤーが直接製造できず-回収また.md)
- 同じ出典の次項: [確定#338：仮称MOD名2件を文学作品名へ正式化——「スローターハウス5」「月を売った男」](/decisions/decision-0338-確定-仮称-名-件を文学作品名へ正式化-スローターハウス-月を売.md)
