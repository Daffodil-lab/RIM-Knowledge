...
- 同じ出典の前項: [確定#251：コロニードクトリンによるユニット製造コスト補正、および3Dプリンターのレシピ自動生成＋変換効率の可変化を確定](/decisions/decision-0251-確定-コロニードクトリンによるユニット製造コスト補正-および-プ.md)
- 同じ出典の次項: [確定#253：研究「ペルソナコア修理」を「ユニット修理」に改称](/decisions/decision-0253-確定-研究-ペルソナコア修理-を-ユニット修理-に改称.md)
