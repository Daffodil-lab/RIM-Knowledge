...
- 権威とライフサイクル: [知識の権威順位とライフサイクル](/governance/authority-and-lifecycle-知識の権威順位とライフサイクル.md)
- 所有者判定: [知識所有者マップ](/governance/ownership-map-知識所有者マップ.md)
- 正仕様記述: [現行資料の正仕様記述](/governance/positive-specification-policy-現行資料の正仕様記述.md)
- 決定履歴: [決定履歴](/decisions/)
