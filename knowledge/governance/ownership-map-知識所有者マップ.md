...
| 兵器の文明規模の製造能力と戦域可用性 | [兵器製造能力と戦域可用性](/world/45-兵器製造能力と戦域可用性.md) | 個別装備、戦役、工業は製造可能と現地使用可能を分離して参照する |
| 戦役級・地域級の戦闘評価 | [体系戦闘評価モデル](/design/59-体系戦闘評価モデル.md) | 戦役とクエストは任務別能力、接続、状態遷移、損耗、補充を再定義せず利用する |
