...
| カエラヴィの遺伝的出自と鳥類系統 | [カエラヴィの遺伝的出自と鳥類系統](/world/48-カエラヴィの遺伝性鳥類系統.md)と各系統所有者 | 三つの出自、六系統、各系統の実装値は共通Xenotype契約へ従う |
...
| カエラヴィRace・身体・遺伝的出自のゲーム表現 | [バニラ優先カエラヴィ種族実装境界](/design/59-バニラ優先カエラヴィ種族実装境界.md)、[カエラヴィ標準身体の実装仕様](/design/60-カエラヴィ標準身体の実装仕様.md)、[カエラヴィXenotype出自階層契約](/design/61-遺伝性鳥類系統の共通Xenotype契約.md) | 世界設定側の外見、生理、由来を再定義しない |
