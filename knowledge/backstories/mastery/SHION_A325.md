...
title: "SHION_A325 地質調査団の石割り"
description: "地質調査というのは、星の日記を読む仕事に似ている。"
tags:
  - "shion"
  - "backstory"
  - "mastery"
...
source_section: "SHION_A325 地質調査団の石割り"
generated:
...
**匿名のソフェルの聞き取り：** 「今も石を集めていますか」 — 「集めるより、撫でる方が習慣になった」

## 実装予約

- Slot: Adulthood
- Pool: Shion_Colonization_Adult / SourceModule: 石の記憶
- Rarity: 希少
- 技能: 採掘+3、知力+3
- 作業不能: なし / 特性候補: なし
...
- 同じ出典の前項: [SHION_A324 資材輸送隊の荷駄頭](/backstories/mastery/SHION_A324.md)
- 同じ出典の次項: [SHION_A326 大気改良班の空薄め師](/backstories/mastery/SHION_A326.md)
- 正史: [正史](/world/index.md)

## 出典

- シオン/Shion ゲーム用バックストーリー完成カタログ v3（退役済み原本: `retired-source://project/docs/38_SHION_BACKSTORY_CATALOG.md`） — `SHION_A325 地質調査団の石割り`
