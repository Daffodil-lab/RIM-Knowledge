...
title: "SHION_A070 死者対話の校正者"
description: "保存人格から生成された返答と、生前に本人が残した言葉を区別して遺族へ示した。"
tags:
  - "shion"
  - "backstory"
  - "mastery"
...
source_section: "SHION_A070 死者対話の校正者"
generated:
...
**匿名のソフェルの余録：** 公開された対話記録では、生前発言、保存記憶、生成返答の出所が文ごとに示されています。遺族は表示範囲を選べますが、区分自体は消せません。
...
- 同じ出典の前項: [SHION_A069 鉄律大導師](/backstories/mastery/SHION_A069.md)
- 同じ出典の次項: [SHION_A071 帝国祈祷復元者](/backstories/mastery/SHION_A071.md)

## 出典

- シオン/Shion ゲーム用バックストーリー完成カタログ v3（退役済み原本: `retired-source://project/docs/38_SHION_BACKSTORY_CATALOG.md`） — `SHION_A070 死者対話の校正者`
