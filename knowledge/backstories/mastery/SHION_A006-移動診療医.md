...
title: "SHION_A006 移動診療医"
description: "車両一台の診療所で辺境を巡り、住民、動物、義肢や補助器官の故障を診た。"
tags:
  - "shion"
  - "backstory"
  - "mastery"
...
source_section: "SHION_A006 移動診療医"
generated:
...
**匿名のソフェルの余録：** 巡回記録には治療と同じ頻度で在庫、隔離場所、通行許可が記されています。専門外の患者は紹介先と搬送条件を明記して引き継がれました。
...
- 同じ出典の前項: [SHION_A005 星図編纂者](/backstories/mastery/SHION_A005-星図編纂者.md)
- 同じ出典の次項: [SHION_A007 動物機工](/backstories/mastery/SHION_A007-動物機工.md)

## 出典

- シオン/Shion ゲーム用バックストーリー完成カタログ v3（退役済み原本: `retired-source://project/docs/38_SHION_BACKSTORY_CATALOG.md`） — `SHION_A006 移動診療医`
