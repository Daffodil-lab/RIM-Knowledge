...
title: "SHION_A412 辺境行政府の巡察官"
description: "開拓地が増えれば増えるほど、本人のところに届く訴えも増えました。"
tags:
  - "shion"
  - "backstory"
  - "mastery"
...
source_section: "SHION_A412 辺境行政府の巡察官"
generated:
...
- Slot: Adulthood
- Pool: Shion_Growth_Adult / SourceModule: 訴えの順番
- Rarity: 希少専門
- 技能: 社交+3、知力+2
- 作業不能: なし / 特性候補: なし
...
- 同じ出典の前項: [SHION_A411 交易船団の交渉員](/backstories/mastery/SHION_A411-交易船団の交渉員.md)
- 同じ出典の次項: [SHION_A413 律法学舎の若きソフェル](/backstories/mastery/SHION_A413-律法学舎の若きソフェル.md)
- 正史: [正史](/world/index.md)

## 出典

- シオン/Shion ゲーム用バックストーリー完成カタログ v3（退役済み原本: `retired-source://project/docs/38_SHION_BACKSTORY_CATALOG.md`） — `SHION_A412 辺境行政府の巡察官`
