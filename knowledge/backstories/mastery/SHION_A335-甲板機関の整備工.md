...
title: "SHION_A335 甲板機関の整備工"
description: "甲板機関の心臓部を止めず、文化的先達から継いだ工具と失敗記録を次の整備者へ渡した。"
tags:
  - "shion"
  - "backstory"
  - "mastery"
...
source_section: "SHION_A335 甲板機関の整備工"
generated:
...
**匿名のソフェルの聞き取り：** 「不具合の記憶は？」 — 「三度とも、俺のせいだ」

## 実装予約

- Slot: Adulthood
- Pool: Shion_Journey_Adult / SourceModule: 遠い岸辺
- Rarity: 希少
- 技能: 工芸+4、知力+2
- 作業不能: なし / 特性候補: なし
...
- 同じ出典の前項: [SHION_A334 移住船団の百人料理番](/backstories/mastery/SHION_A334-移住船団の百人料理番.md)
- 同じ出典の次項: [SHION_A336 種子庫の女管理人](/backstories/mastery/SHION_A336-種子庫の女管理人.md)
- 正史: [正史](/world/index.md)

## 出典

- シオン/Shion ゲーム用バックストーリー完成カタログ v3（退役済み原本: `retired-source://project/docs/38_SHION_BACKSTORY_CATALOG.md`） — `SHION_A335 甲板機関の整備工`
