...
title: "SHION_A312 船団医療班の縫合手"
description: "「針が足りない、代わりは何がある」と船医に聞かれたとき、本人は魚の骨を煮沸したものを渡した。"
tags:
  - "shion"
  - "backstory"
  - "mastery"
...
source_section: "SHION_A312 船団医療班の縫合手"
generated:
...
- Slot: Adulthood
- Pool: Shion_Colonization_Adult / SourceModule: 宇宙のランデヴー
- Rarity: 希少
- 技能: 医術+5
- 作業不能: なし / 特性候補: なし
...
- 同じ出典の前項: [SHION_A311 山稜路の道普請師](/backstories/mastery/SHION_A311-山稜路の道普請師.md)
- 同じ出典の次項: [SHION_A313 気象班の嵐読み](/backstories/mastery/SHION_A313-気象班の嵐読み.md)
- 正史: [正史](/world/index.md)

## 出典

- シオン/Shion ゲーム用バックストーリー完成カタログ v3（退役済み原本: `retired-source://project/docs/38_SHION_BACKSTORY_CATALOG.md`） — `SHION_A312 船団医療班の縫合手`
