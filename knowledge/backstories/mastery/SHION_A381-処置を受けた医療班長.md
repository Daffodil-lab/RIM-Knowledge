...
title: "SHION_A381 処置を受けた医療班長"
description: "今の本人は、あの頃の同僚がとうに見送った時間の先にいます。"
tags:
  - "shion"
  - "backstory"
  - "mastery"
...
source_section: "SHION_A381 処置を受けた医療班長"
generated:
...
- Slot: Adulthood
- Pool: Shion_Journey_Adult / SourceModule: 凍らない川
- Rarity: 希少
- 技能: 医術+5、知力+3
- 作業不能: なし / 特性候補: なし
...
- 同じ出典の前項: [SHION_A380 農区統合の教訓](/backstories/mastery/SHION_A380-農区統合の教訓.md)
- 同じ出典の次項: [SHION_A382 帝国最初の設計技師](/backstories/mastery/SHION_A382-帝国最初の設計技師.md)
- 正史: [正史](/world/index.md)
- 制作・開示規則: [制作・開示規則](/authoring/index.md)

## 出典

- シオン/Shion ゲーム用バックストーリー完成カタログ v3（退役済み原本: `retired-source://project/docs/38_SHION_BACKSTORY_CATALOG.md`） — `SHION_A381 処置を受けた医療班長`
