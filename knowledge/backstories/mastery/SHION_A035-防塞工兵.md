...
title: "SHION_A035 防塞工兵"
description: "帝国内戦中、地下へ防壁、退避路、崩落防止構造を築く工兵となった。"
tags:
  - "shion"
  - "backstory"
  - "mastery"
...
source_section: "SHION_A035 防塞工兵"
generated:
...
**匿名のソフェルの余録：** 停戦中の共同補修と、再戦後に退避路を攻撃対象から外した記録があります。相手技師の生存・蘇生記録は現在も確認されていません。
...
- 技能: 建築+9、採掘+4、芸術−12
- 作業不能: なし / 特性候補: なし
- 組合せ: ImperialCivilWar限定。停戦線修復・廃船音響・採掘系幼少期向け。
...
- 同じ出典の前項: [SHION_A034 戦場衛生技師](/backstories/mastery/SHION_A034-戦場衛生技師.md)
- 同じ出典の次項: [SHION_A036 長距離斥候](/backstories/mastery/SHION_A036-長距離斥候.md)

## 出典

- シオン/Shion ゲーム用バックストーリー完成カタログ v3（退役済み原本: `retired-source://project/docs/38_SHION_BACKSTORY_CATALOG.md`） — `SHION_A035 防塞工兵`
