...
title: "SHION_A351 混住区の水利管理人"
description: "混住区の水利管理人では、俺は継ぎ接ぎの民の文化を継ぐ。"
tags:
  - "shion"
  - "backstory"
  - "mastery"
...
source_section: "SHION_A351 混住区の水利管理人"
generated:
...
**匿名のソフェルの聞き取り：** 「失敗だったのか？」 — 「判断は班長がした」

## 実装予約

- Slot: Adulthood
- Pool: Shion_Journey_Adult / SourceModule: 甲板の教区
- Rarity: 希少
- 技能: 建築+4、知力+2、社交-1
- 作業不能: なし / 特性候補: なし
...
- 同じ出典の前項: [SHION_A350 儀礼班の道具管理人](/backstories/mastery/SHION_A350-儀礼班の道具管理人.md)
- 同じ出典の次項: [SHION_A352 統合戸籍局の記録係](/backstories/mastery/SHION_A352-統合戸籍局の記録係.md)
- 正史: [正史](/world/index.md)

## 出典

- シオン/Shion ゲーム用バックストーリー完成カタログ v3（退役済み原本: `retired-source://project/docs/38_SHION_BACKSTORY_CATALOG.md`） — `SHION_A351 混住区の水利管理人`
