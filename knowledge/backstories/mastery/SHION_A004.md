...
title: "SHION_A004 記念庭園設計者"
description: "死者や失われた共同体を記念する庭園を設計した、また遺族が望む植物、開花時期、訪問しやすい通路を聞き取り、一つの英雄像へ記憶をまとめすぎないようにした。"
tags:
  - "shion"
  - "backstory"
  - "mastery"
...
source_section: "SHION_A004 記念庭園設計者"
generated:
...
**匿名のソフェルの余録：** 庭園図には遺族ごとの希望と帰還後の増設区画が残ります。蘇生後も追悼区画を撤去せず、本人と遺族双方の利用経路を設けました。
...
- 同じ出典の前項: [SHION_A003 公共食堂主任](/backstories/mastery/SHION_A003.md)
- 同じ出典の次項: [SHION_A005 星図編纂者](/backstories/mastery/SHION_A005.md)

## 出典

- シオン/Shion ゲーム用バックストーリー完成カタログ v3（退役済み原本: `retired-source://project/docs/38_SHION_BACKSTORY_CATALOG.md`） — `SHION_A004 記念庭園設計者`
