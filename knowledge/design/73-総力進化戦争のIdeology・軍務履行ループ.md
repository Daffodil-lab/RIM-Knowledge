...
`PreferredXenotype`も標準構成へ入れない。カエラヴィは六つの遺伝性Xenotypeを持ち、どれか三系統だけを好ましいカエラヴィとして固定しない。カエラヴィ判定はXenotype名ではなく種族ThingDef `CA_Caelavi`を用い、軍務Xenogerm、混成系統、後天的遺伝子を民族資格の喪失へ結びつけない。
