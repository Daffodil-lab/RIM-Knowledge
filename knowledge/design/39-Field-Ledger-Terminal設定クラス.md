...
title: "39. 工業管制塔設定クラス"
description: "工業管制塔は、独立遠征共同体がコンビナートの生産、消費、流通と非貨幣の同盟Credit Accountへ触れるための現地端末である。"
tags:
  - "shion"
  - "design"
  - "setting"
...
工業管制塔は、独立遠征共同体がコンビナートの生産、消費、流通と、能力・実績・制度的信用に基づく非貨幣の同盟Credit Accountへ触れるための現地端末である。コアMODからコンビナートへ入る最初の可視入口として使われ、選択時に登録済みの全管理ページと全操作へ到達できる。現行α版では独立遠征共同体向けの表示名を「工業管制塔」とする。将来、役割や由来の異なる端末を追加する場合は、同名の性能差へ押し込まず別の設定クラスとして審査する。
...
- 同盟Credit: [同盟Credit](/world/39-同盟通貨.md)
