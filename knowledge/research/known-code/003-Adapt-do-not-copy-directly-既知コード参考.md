...
- 同じ出典の前項: [Adopted and ported](/research/known-code/002-Adopted-and-ported-既知コード参考.md)
- 同じ出典の次項: [Rejected from the runtime](/research/known-code/004-Rejected-from-the-runtime-既知コード参考.md)
