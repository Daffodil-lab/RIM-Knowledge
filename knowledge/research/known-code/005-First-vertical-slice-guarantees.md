...
- 同じ出典の前項: [Rejected from the runtime](/research/known-code/004-Rejected-from-the-runtime.md)
- 同じ出典の次項: [Next extraction](/research/known-code/006-Next-extraction.md)
