...
- 同じ出典の前項: [Sources inspected](/research/known-code/001-Sources-inspected-既知コード参考.md)
- 同じ出典の次項: [Adapt, do not copy directly](/research/known-code/003-Adapt-do-not-copy-directly-既知コード参考.md)
