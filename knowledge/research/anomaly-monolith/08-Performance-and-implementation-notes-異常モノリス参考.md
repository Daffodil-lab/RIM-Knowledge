...
- 同じ出典の前項: [7. Relationship to existing references](/research/anomaly-monolith/07-Relationship-to-existing-references-異常モノリス参考.md)
- 同じ出典の次項: [9. Updated Core prompt guidance](/research/anomaly-monolith/09-Updated-Core-prompt-guidance-異常モノリス参考.md)
