...
- 同じ出典の前項: [5. Research tab stability](/research/monolyn-ui/05-Research-tab-stability.md)
- 同じ出典の次項: [7. UI/system strengths to learn from](/research/monolyn-ui/07-UI-system-strengths-to-learn-from.md)
