...
- 同じ出典の前項: [4. Icon and description ambiguity](/research/monolyn-ui/04-Icon-and-description-ambiguity.md)
- 同じ出典の次項: [6. Other compatibility and implementation issues](/research/monolyn-ui/06-Other-compatibility-and-implementation-issues.md)
