...
- 同じ出典の前項: [2. Overall system reception](/research/monolyn-ui/02-Overall-system-reception-モノリン操作画面参考.md)
- 同じ出典の次項: [4. Icon and description ambiguity](/research/monolyn-ui/04-Icon-and-description-ambiguity-モノリン操作画面参考.md)
