...
- 同じ出典の前項: [3. Human mutation, core creation, and division loop](/research/fleshbeast/03-Human-mutation-core-creation-and-division-loop.md)
- 同じ出典の次項: [5. Buildings and infrastructure](/research/fleshbeast/05-Buildings-and-infrastructure.md)
